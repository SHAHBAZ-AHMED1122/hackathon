  ...
  return (
    <div className='bg-black'>
      <Image className='text-center mx-auto'
          ...
          <div className='flex items-center justify-between  border-b border-yellow-500 pb-20'>

          <div>
          <h1 className="font-bold text-[48px] text-white pt-4 pb-4 ">
          ...
          <div className=''>
            <input className='p-2 bg-yellow-400 text-white rounded-sm' type="text" placeholder='Enter your Email' /><span className='text-yellow-500 rounded-sm bg-white p-[11px] '>subscribe</span>
          </div>
          </div>
    </div>
  )
